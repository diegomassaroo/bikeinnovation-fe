...
.wp-admin-link {
  @apply inline-flex items-center bg-yellow-400 leading-tight py-1 px-2 rounded gap-1 text-yellow-900 border-b border-yellow-500 uppercase transition-all duration-100 ease-in-out;
