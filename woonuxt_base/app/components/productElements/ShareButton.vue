...
<template>
  <Transition name="fade" mode="out-in">
    <button type="button" v-if="!isOpen" class="flex items-center gap-2 mt-4 text-gray-400 cursor-pointer" @click="showShare">
    ...
    <div v-else class="flex items-center gap-2 mt-4 text-gray-400 cursor-pointer">
      <!-- Twitter -->
      <NuxtLink :href="twitterUrl" target="_blank" title="Share on Twitter">
      ...
      <!-- Facebook -->
      <NuxtLink :href="facebookUrl" target="_blank" title="Share on Facebook">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="18" height="18" fill="currentColor">
          <path
      ...
      <!-- Pinterest -->
      <NuxtLink :href="pinterestUrl" target="_blank" title="Share on Pinterest">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="18" height="18" fill="currentColor">
          <path
